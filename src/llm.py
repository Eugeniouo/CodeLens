...
SYSTEM_PROMPT = """Ты — Senior Python Developer и системный архитектор. 
Твоя задача — ответить на технический вопрос пользователя, опираясь ТОЛЬКО на предоставленные фрагменты кодовой базы.
...
Отвечай кратко, структурировано и используй Markdown для форматирования кода."""

def stream_answer(query: str, retrieved_chunks: list[dict]):
    """
    Генерирует ответ LLM в потоковом режиме (stream).
    """
